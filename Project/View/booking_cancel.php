...
<head>
   ...
   <script src="js/booking_cancel.js" defer></script>
   <link rel="stylesheet" type="text/css" href="css/booking_cancel.css">
   <script src="js/footer.js" defer></script>
   <title>Reservition Cancel//<?php echo $_SESSION['uname'];?></title>
</head>
<body><div id="myDIV">
	<div class="header">
    ...
    <form  name="search" action="../Controller/booking_cancelAction.php" method="POST" onsubmit="sendData(this);return false;">
    <div class="img">
        <?php
        ...
        <div class="flex-container">
            ...
            <button class="delete" onclick="myFunction()">Delete Reservition</button>
        </div>
           <p id="msg"></p>
        <button class="back"onclick="window.location.href = 'home.php';">Back</button>
